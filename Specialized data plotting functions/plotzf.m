...
function dataStruct  = plotzf(results,timeRange)
...
grid(axes2,'on');
hold(axes2,'all');
plot(tgood,results.d(inds),'g','linewidth',2);
plot(tgood,results.a(inds),'r','linewidth',2);
xlim([0 tgood(end)]);

dataStruct.time = tgood;
dataStruct.z = zOut;
dataStruct.d = results.d(inds);
dataStruct.a = results.a(inds);