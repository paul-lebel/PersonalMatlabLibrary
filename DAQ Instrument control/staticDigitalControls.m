...
[mh_obj, ang_obj, Controller] = initPIparallel();
handles.Controller = Controller;
handles.mh_obj = mh_obj;
handles.ang_obj = ang_obj;
handles.force = 0;
...
% close PI objects
handles.mh_obj.MOV('1',0);
handles.ang_obj.CloseConnection;
handles.mh_obj.CloseConnection;
handles.Controller.CloseConnection();
